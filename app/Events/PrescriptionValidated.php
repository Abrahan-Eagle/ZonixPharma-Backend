...
/**
 * Se emite cuando el farmacéutico colegiado aprueba la receta.
 * El pedido sale de `pending_prescription_validation` → `pending_payment`.
 */
class PrescriptionValidated implements ShouldBroadcast
{
    ...
    public function broadcastWith(): array
    {
        return [
            ...
            'validated_at' => optional($this->prescription->validated_at)?->toISOString(),
        ];
    }

    public function broadcastAs(): string
    {
        return 'PrescriptionValidated';
    }
}
