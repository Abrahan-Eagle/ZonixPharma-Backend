...
| **`bb3f5be`** | UX Flujo Total vs template: **Concepto** B16, TIR **%**, **Tasa r**, **% SAFE recuperado**, labels K22/L22, I17 vacío activas         | ✅ verify exit **0** |
...
| Concepto           | Lean (canon)               |
| ------------------ | -------------------------- |
| Capital SAFE       | **~USD 111.988** _(≈112k)_ |
| SAFE cap           | **600.000**                |
| Fase 0             | **33.835**                 |
| Caja Day-D         | **78.153**                 |
...
_Generado por JARVIS — auditoría forense v3 pack Lanzamiento Zonix Pharma. **Fase 3** commit `d7b7df4` (23 jun 2026). **P0-06** actualizado mismo día._
