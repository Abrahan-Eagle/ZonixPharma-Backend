# Marketing offline y digital — Valencia piloto

**Para:** Gabriel Barrios — Gerente de Consultoría, Grupo Morr (Valencia, Venezuela)  
**De:** Abrahan Pulido — Founder / CEO / CTO, Zonix Pharma  
**Fecha:** junio 2026

**No es una solicitud de inversión.** Explica **dónde pondremos el dinero de marketing** en Carabobo: digital primero (Meta Ads), offline complementario (valla, flyers) y reglas de copy en salud.
...
## Filosofía: digital primero

**Por qué Meta Ads manda el presupuesto:**

1. **Costo por contacto bajo** en VE (referencia pack: USD 0,15–0,60 por lead digital vs USD 5–15 offline difuso).
2. **Medición:** sabemos quién hizo clic, instaló la app o pidió; la valla es estimación.
3. **Ajuste rápido:** un anuncio se corrige en horas; una valla está fija ~30 días.
4. **Audiencia:** clase media venezolana 2026 vive en Instagram, TikTok y WhatsApp.
...
## Valla publicitaria (Lean: USD 350/mes)

### Tamaño y precio

| Tamaño | Ubicación típica | USD/mes |
|--------|------------------|---------|
| Pequeña 3m×2m | Avenida secundaria | 250–400 |
| **Pequeña 3m×2m** | **Av. principal (Bolívar Norte / Cedeño)** | **350–500** ← **Lean** |
| Mediana 6m×4m | Av. principal | 600–900 |
