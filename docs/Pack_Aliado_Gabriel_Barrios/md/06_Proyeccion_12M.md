> **Espejo Pack Aliado** (sync v5 7-ago-2026) desde [`docs/Lanzamiento/PROYECCION_FINANCIERA_12M.md`](../../../docs/Lanzamiento/PROYECCION_FINANCIERA_12M.md). Fuente de verdad = Lanzamiento + Excel v4.
...
> **Billing (ajuste pack):** la columna **Revenue** = P&L Excel (híbrido cuota **45/60/70** + % GMV). **ARPF ~52** es placeholder de UNIT_ECONOMICS — **no** el cociente Revenue÷activas (M1: 7.520/40 ≈ 188). Detalle comercial: [PROPUESTA_VALOR_CLIENTE_B2B.md](PROPUESTA_VALOR_CLIENTE_B2B.md) §5.
...
Con el **esc.1 vigente** (pricing **45/60/70** + % GMV), el FCF mensual es negativo M1–M4 y positivo desde **M5** (ingresos M1 **7.520** < costos **11.411**). Mitigaciones si la curva real va más lenta: (1) recorte de burn (valla, Meta); (2) mejorar mix ARPF; (3) bridge trimestral. FCF Y1 **+59.079**; cash M12 **246.231**.
