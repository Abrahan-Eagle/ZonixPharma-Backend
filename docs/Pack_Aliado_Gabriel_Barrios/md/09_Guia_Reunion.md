# Guía de reunión — Aliado estratégico

**Para:** Gabriel Barrios — Gerente de Consultoría, Grupo Morr (Valencia, Venezuela)  
**De:** Abrahan Pulido — Founder / CEO / CTO, Zonix Pharma  
**Fecha:** junio 2026

**No es una solicitud de inversión** salvo que acordemos otra cosa en reunión. Este documento sirve para preparar una conversación de alianza, asesoría y revisión del piloto en Carabobo — no un guion para un fondo anónimo.
...
## Qué es esta reunión (y qué no)

| Sí | No |
|----|-----|
| Alinear visión del piloto Valencia | Pitch genérico a inversor institucional |
| Revisar números y calendario comercial | Pedir capital sin contexto previo |
| Explorar cómo Grupo Morr puede aportar (red, consultoría, intro farmacias) | Comprometer exclusividad o equity en la primera cita |
| Demo del producto si hay tiempo | Due diligence legal completa |

Gabriel conoce el mercado local; la reunión debe aprovechar eso: validar hipótesis de precio, segmento beachhead y ritmo de captación — no repetir slides que ya están en el pack.

---

## Antes de sentarnos (checklist founder)

### Material útil para traer

- Resumen de una página del proyecto (Brief).
- Proyección 12 meses y guía del modelo financiero (Excel adjunto al pack).
- Propuestas de valor: farmacia, paciente y partners (documentos 11–13 de este pack).
- Plan de lanzamiento T+0 → Day-D → M12 (documento 10).
- Demo en tablet o teléfono: paciente busca medicamento, farmacia recibe pedido, farmacéutico valida receta, entrega coordinada.
...
### Preguntas que Gabriel puede hacer (y respuestas ancladas)
...
## Guion sugerido (45–60 minutos)

| Minutos | Tema | Objetivo |
|---------|------|----------|
...
### Si hay tiempo: demo (~10 min)

1. Paciente busca OTC o Rx, arma carrito, sube receta si aplica, paga con método local.
2. Farmacia ve el pedido en su panel y prepara.
3. Farmacéutico colegiado aprueba o rechaza la receta (objetivo ≤ 60 min).
4. Empresa de delivery asigna repartidor; paciente ve estado del envío.

Sin entrar en detalle técnico: lo importante es que el flujo es creíble para una farmacia de barrio y un paciente con smartphone.

---

## Temas para profundizar según interés de Gabriel
...
- TAM pharma Venezuela ~**1.638 M USD/año** (Cifar / IMS-IQVIA).
- Nicho piloto: independientes y medianas Valencia metro (~80–100 target sobre ~226 puntos censados).
- Competencia digital fuerte en cadenas; agregadores genéricos con comisión alta al independiente.

### Ejecución y finanzas
...
No presentar esto como ask a Gabriel salvo que él lo abra.

---

## Posibles resultados de la reunión

1. **Interés en aliarse como asesor / introductor:** acordar alcance (no exclusivo), próxima sesión con documentos 10–13 y censo farmacias.
2. **Pide tiempo para revisar el pack:** enviar carpeta completa; reunión de seguimiento en 7–10 días.
3. **Sugiere ajustes al plan:** anotar feedback (precio, zonas, ritmo); actualizar notas internas — no cambiar cifras del pack sin decisión founder.
4. **No encaja ahora:** agradecer feedback honesto; mantener relación para intros futuras.

### Próximos pasos genéricos (si hay química)

- Email de seguimiento en 24 h con resumen de la conversación.
- Compartir pack completo si aún no lo tiene.
- Segunda sesión en 7–10 días: profundizar en `11_Propuesta_Farmacia.md` y `18_Guia_Modelo_Financiero.md`.
- Si Gabriel conoce farmacias: acordar **2–3 intros discovery** sin compromiso comercial (entrevistas mom-test de pricing).
...
Documentos hermanos útiles para la segunda sesión: `10_Plan_Lanzamiento.md`, `11_Propuesta_Farmacia.md`, `18_Guia_Modelo_Financiero.md`.

---

## Preguntas frecuentes (si la conversación se alarga)
...
## Qué NO prometer en esta reunión

- No garantizar número de pedidos a una farmacia individual.
- No firmar exclusividad con Morr ni con ningún aliado en la primera cita.
- No presentar T&C o SAFE como versión legal final sin sello de abogado.
- No cambiar cifras del pack (ARPF, CAC, curva) en vivo sin decisión founder.

---

## Disclaimers

- **Pre-revenue:** las cifras son proyección con supuestos documentados; se recalibran con GMV real del piloto.
- **No solicitud de inversión:** salvo acuerdo explícito en reunión; Gabriel recibe material de contexto y alianza.
- **Regulatorio:** Zonix no sustituye al farmacéutico titular ni al criterio médico; textos legales en borrador hasta dictamen profesional.
- **Inflación Venezuela:** cifras en USD constantes, referencia mayo–junio 2026.
- **Confidencialidad:** no compartir el pack fuera del círculo acordado sin permiso del founder.
