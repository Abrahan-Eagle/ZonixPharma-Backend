...
> **Nota FP&A — columna «Farmacias firmadas» vs total **175**:** la suma aritmética de la columna mensual da **185** altas brutas en M1–M12; la fila **Total** muestra **175** como **objetivo neto de planning** coherente con §1.2 (~175 firmas/año, ~10,7/mes de media con 4× Sales). La diferencia (~10) refleja **ajuste de modelo** (re-trabajos, duplicados operativos o recalibración de capacidad) — **no** usar 185 como ancla de pitch sin recalcular con FP&A post-piloto. **Fuente de verdad operativa:** columna *Farmacias activas* y revenue §1.1.
>
