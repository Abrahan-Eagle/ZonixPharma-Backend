            ...
            <div class="row g-5 mb-5 text-white">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="d-flex gap-3">
                        <!-- Facebook -->
                        <a href="https://www.facebook.com/share/1C9RPAKF5k/" target="_blank" rel="noopener noreferrer" class="social-icon-btn" aria-label="Facebook">
                        ...
                        <!-- Instagram -->
                        <a href="https://www.instagram.com/zonixpharma" target="_blank" rel="noopener noreferrer" class="social-icon-btn" aria-label="Instagram">
                        ...
                        <!-- TikTok -->
                        <a href="https://tiktok.com/@zonixpharma" target="_blank" rel="noopener noreferrer" class="social-icon-btn" aria-label="TikTok">
    ...
    <div class="offcanvas-menu" id="offcanvasMenu">
        ...
        <div class="mt-auto bg-slate-50 p-4 rounded-xl">
            <div class="d-flex gap-3 mb-4">
                <a href="https://www.instagram.com/zonixpharma" target="_blank" rel="noopener noreferrer" class="btn btn-icon bg-white text-navy hover-scale" aria-label="Instagram"><i class="bi bi-instagram"></i></a>
                ...
                <a href="https://www.facebook.com/share/1C9RPAKF5k/" target="_blank" rel="noopener noreferrer" class="btn btn-icon bg-white text-navy hover-scale" aria-label="Facebook"><i class="bi bi-facebook"></i></a>
            </div>
